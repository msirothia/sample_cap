...
declare class XsuaaSecurityContext extends SecurityContext {
    /**
     * @param {XsuaaService} service
     * @param {XsuaaToken} token
     * @param {Types.SecurityContextConfig} contextConfig
     */
    constructor(service: XsuaaService, token: XsuaaToken, contextConfig: Types.SecurityContextConfig);
    /**
...
declare namespace XsuaaSecurityContext {
    export { XsuaaToken, XsuaaService };
}
